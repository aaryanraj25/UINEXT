...
const hero = () => {
  ...
  const handleCountdown = () => {
    const countDate = new Date("October 26, 2024 10:00:00").getTime();
        ...
        <section className="column">
          <div className="left_side">
            ...
            <div className="title1">
              <span className="hackathon"> {"UI - NEXT by UNISOC"}</span>
              <br />
